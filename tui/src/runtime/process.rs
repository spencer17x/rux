...
console.log(JSON.stringify({kind:'event',event:{type:'runtime.ready',status:{protocolVersion:7,pid:process.pid,platform:process.platform,workspaceRoot:process.env.RUX_WORKSPACE_ROOT,startedAt:'test'}}}));
