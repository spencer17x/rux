...
export type RuxSettings = { provider: "codex" | "custom"; serviceName: string; baseUrl: string; encryptedApiKey: string; hasApiKey: boolean; model: string; reasoning: ReasoningEffort; sandboxMode: SandboxMode; uiFontSize: number; allowConversationOverride: boolean; conversationSticky: boolean; customImageInput: boolean; customFileInput: boolean };

export class SettingsStore {
  constructor(private readonly path: string) {}
  defaults(): RuxSettings { return { provider: "codex", serviceName: "OpenAI Compatible", baseUrl: "https://api.openai.com/v1", encryptedApiKey: "", hasApiKey: false, model: "", reasoning: "high", sandboxMode: "workspace-write", uiFontSize: 14, allowConversationOverride: true, conversationSticky: true, customImageInput: false, customFileInput: false }; }
