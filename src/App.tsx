...
function App() {
  ...
  const assistantProps = {
    ...
    fullAccessEnabled: supportsSandbox && activeSandboxMode === "danger-full-access",
    onDisableFullAccess: () => { void selectSandbox(selectedAgent === "pi" ? "read-only" : "workspace-write"); },
